#---------------------------------------------------------------
# function of date conversion and coordinates manipulating
# Comment in progress
#---------------------------------------------------------------
...
class init_time():
	'''
	init_time defines the time class for FILDA 
	'''

	def __init__(self, jdn, overpass):
		...
		self.h		= self.OP[0:2]
		self.m		= self.OP[2:]
		self.GOES	= get_displatDate(jdn, format = 'yyyymmdd') + '_' + self.h
